...
describe('Component Tests', () => {
  describe('ValidationRequest Management Component', () => {
    let comp: ValidationRequestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ValidationRequestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.validationRequests?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
