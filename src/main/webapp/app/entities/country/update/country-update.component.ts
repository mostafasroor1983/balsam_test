...
export class CountryUpdateComponent implements OnInit {
  ...
  editForm = this.fb.group({
    ...
    phoneCode: [null, [Validators.maxLength(6)]],
    membershipCode: [null, [Validators.maxLength(6)]],
  });
  ...
  protected updateForm(country: ICountry): void {
    this.editForm.patchValue({
      ...
      membershipCode: country.membershipCode,
    });
  }
  ...
  protected createFromForm(): ICountry {
    return {
      ...
      membershipCode: this.editForm.get(['membershipCode'])!.value,
    };
  }
}
