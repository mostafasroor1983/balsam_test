...
class CityResourceIT {
    ...
    void getAllCitiesByCodeIsEqualToSomething() throws Exception {
        ...
        // Get all the cityList where code equals to DEFAULT_CODE
        defaultCityShouldBeFound("code.equals=" + DEFAULT_CODE);

        // Get all the cityList where code equals to UPDATED_CODE
        defaultCityShouldNotBeFound("code.equals=" + UPDATED_CODE);
    }

    @Test
    @Transactional
    void getAllCitiesByCodeIsNotEqualToSomething() throws Exception {
        // Initialize the database
        cityRepository.saveAndFlush(city);

        // Get all the cityList where code not equals to DEFAULT_CODE
        defaultCityShouldNotBeFound("code.notEquals=" + DEFAULT_CODE);

        // Get all the cityList where code not equals to UPDATED_CODE
        defaultCityShouldBeFound("code.notEquals=" + UPDATED_CODE);
    }
    ...
    void getAllCitiesByCodeIsInShouldWork() throws Exception {
        ...
        // Get all the cityList where code in DEFAULT_CODE or UPDATED_CODE
        defaultCityShouldBeFound("code.in=" + DEFAULT_CODE + "," + UPDATED_CODE);

        // Get all the cityList where code equals to UPDATED_CODE
        defaultCityShouldNotBeFound("code.in=" + UPDATED_CODE);
    }
    ...
    void getAllCitiesByCodeIsNullOrNotNull() throws Exception {
        ...
        defaultCityShouldBeFound("code.specified=true");

        // Get all the cityList where code is null
        defaultCityShouldNotBeFound("code.specified=false");
    }
    ...
    void getAllCitiesByCodeContainsSomething() throws Exception {
        ...
        // Get all the cityList where code contains DEFAULT_CODE
        defaultCityShouldBeFound("code.contains=" + DEFAULT_CODE);

        // Get all the cityList where code contains UPDATED_CODE
        defaultCityShouldNotBeFound("code.contains=" + UPDATED_CODE);
    }
    ...
    void getAllCitiesByCodeNotContainsSomething() throws Exception {
        ...
        // Get all the cityList where code does not contain DEFAULT_CODE
        defaultCityShouldNotBeFound("code.doesNotContain=" + DEFAULT_CODE);

        // Get all the cityList where code does not contain UPDATED_CODE
        defaultCityShouldBeFound("code.doesNotContain=" + UPDATED_CODE);
    }
